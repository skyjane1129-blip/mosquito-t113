...
public partial class PhotoActions : UserControl
{
    ...
    private async void Analyze(object sender, RoutedEventArgs e) { if (DataContext is PhotoViewModel photo) await photo.AnalyzeAsync(); }
    private void ToggleAnnotated(object sender, RoutedEventArgs e) { if (DataContext is PhotoViewModel photo) photo.ShowAnnotated = !photo.ShowAnnotated; }
}
